package com.pujadas.rollcall.degreedetail
...
import com.pujadas.rollcall.studentdata.StudentRow
                            ...
                            DropdownMenu(
                                ...
                                DropdownMenuItem(
                                    text = {
                                        Row(verticalAlignment = Alignment.CenterVertically) {
                                            Icon(
                                                painterResource(R.drawable.googlecalendericon),
                                                contentDescription = null,
                                                Modifier.size(20.dp),
                                                tint = Color.Unspecified
                                            )
                                            Spacer(modifier = Modifier.width(8.dp))
                                            Text("Add to Calendar", fontSize = 15.sp, fontFamily = Laila)
                                        }
                                    },
                                    onClick = {
                                        menuExpanded = false
...
/* ✅ new added: Open Google Calendar */
fun addEventToGoogleCalendar(context: Context, date: String, title: String) {
    try {
        ...
        val intent = Intent(Intent.ACTION_INSERT).apply {
            ...
            putExtra(CalendarContract.Events.DESCRIPTION, "Class scheduled for $date")
